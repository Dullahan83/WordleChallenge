          ...
          <g>
            ...
            <g>
              ...
              <g>
                ...
                <path
                  style={{ fill: "#595A59" }}
                  d="M327.557,489.117V512H71.028v-22.883c0-2.296,1.481-4.444,4.073-6.591 c2.592-2.147,6.22-4.147,10.516-5.999c17.774-7.85,46.063-13.182,50.136-13.182h127.154c3.999,0,32.288,5.258,50.062,13.108 c4.295,1.926,7.924,3.925,10.516,6.073h0.074C326.076,484.673,327.557,486.821,327.557,489.117z"
                ></path>{" "}
                <g>
                  {" "}
                  <rect
                ...
                <polygon
                  style={{ fill: "#555555" }}
                  points="312.969,378.478 85.617,378.478 124.274,328.416 274.311,328.416 "
                ></polygon>{" "}
                <linearGradient
                  id="SVGID_2_"
                  gradientUnits="userSpaceOnUse"
                ...
                >
                  {" "}
                  <stop offset="0" style={{ stopColor: "#F9E298" }}></stop>{" "}
                  <stop offset="0.9951" style={{ stopColor: "#F0CB72" }}></stop>{" "}
                </linearGradient>{" "}
                <path
                  style={{ fill: "url(#SVGID_2_)" }}
                  d="M236.617,174.676v73.982c-12.071-0.37-24.587-0.444-37.25-0.444h-4.073 c-11.479,0-22.513,0.074-33.325,0.444v-73.982H236.617z"
                ></path>{" "}
                <linearGradient
                  id="SVGID_3_"
                  gradientUnits="userSpaceOnUse"
                ...
                <path
                  ...
                  d="M252.169,323.602v15.256H146.417v-15.256c0-5.702,4.591-10.442,10.368-10.59 c0.148-0.074,0.222-0.074,0.37-0.074h84.572l0.074,0.074c1.407,0,2.74,0.297,3.999,0.889c0.592,0.297,1.185,0.593,1.777,1.037 c0.37,0.222,0.74,0.518,1.037,0.815c0.296,0.222,0.519,0.444,0.74,0.741c0.37,0.37,0.667,0.74,0.963,1.185 c0.296,0.444,0.592,0.889,0.814,1.407c0.148,0.222,0.222,0.444,0.297,0.667c0.074,0.074,0.074,0.148,0.074,0.222 c0.222,0.444,0.37,0.963,0.444,1.481C252.094,322.121,252.169,322.862,252.169,323.602z"
                ></path>{" "}
                <linearGradient
                  id="SVGID_6_"
                  gradientUnits="userSpaceOnUse"
                ...
                <g>
                  ...
                  <g>
                        ...
                        <g>
                          ...
                          <g>
                            ...
                            >
                              ...
                              <stop
                                offset=".9951"
                                style={{ stopColor: "#F0CB72" }}
                              ></stop>{" "}
                            </linearGradient>{" "}
                            <path
                              style={{ fill: "url(#SVGID_8_)" }}
                              d="M110.291,142.8C52.577,142.8,5.624,91.146,5.624,27.655 c0-3.511,2.587-6.357,5.778-6.357c3.192,0,5.778,2.846,5.778,6.357c0,56.48,41.77,102.431,93.111,102.431 c3.192,0,5.779,2.846,5.779,6.357C116.07,139.953,113.483,142.8,110.291,142.8z"
                            ></path>{" "}
                          </g>{" "}
                          <g>
                            {" "}
                    ...
                    <g>
                      ...
                      <path
                        style={{ fill: "url(#SVGI}_15_)" }}
                        d="M304.414,62.964l1.768,9.357c-0.324-0.432-0.636-0.877-0.936-1.335 c-2.566-3.801-4.692-7.832-6.379-12.065v-0.013c-0.982-2.466-1.826-5.009-2.496-7.59c-2.196-8.353-2.762-17.202-1.572-26.076 c0.231-1.742,0.798-3.331,1.63-4.704l0.936,4.971L304.414,62.964z"
                      ></path>{" "}
                      <linearGradient
                        id="SVGID_16_"
                        gradientUnits="userSpaceOnUse"
                      ...
                      <path
                        style={{ fill: "url(#SVGI}_16_)" }}
                        d="M306.945,73.377l8.933,50.46l-9.696-51.516 C306.425,72.677,306.679,73.033,306.945,73.377z"
                      ></path>{" "}
                      <linearGradient
                        id="SVGID_17_"
                        gradientUnits="userSpaceOnUse"
                        ...
                        <g>
                          ...
                          <g>
                            ...
                            <linearGradient
                              ...
                              x2="2806.4565"
                              y2="21.3015"
                              gradientTransform="matrix(-1 0 0 1 3144.1953 0)"
                            >
                              {" "}
                              <stop
                                offset="0"
                        ...
                        <g>
                          ...
                          <g>
                            ...
                            <path
                              ...
                              d="M340.275,172.67c-0.462,0.305-0.948,0.598-1.422,0.877 c-3.34,1.882-6.946,2.784-10.505,2.784c-7.836,0-15.486-4.373-19.832-12.281c-3.791-6.878-4.923-14.964-3.201-22.783 c0.012-0.063,0.023-0.114,0.035-0.178c1.283-5.696,3.964-10.743,7.743-14.697c0.867-0.915,1.791-1.767,2.785-2.543 c0-0.013,0-0.013,0.012,0c0.636-0.521,1.294-1.004,1.976-1.462c1.791-1.182,3.964-1.068,5.594,0.114 c0.15,0.089,0.289,0.191,0.416,0.331c0-0.013,0.011,0,0.011,0c0.474,0.407,0.89,0.915,1.225,1.526 c1.514,2.746,0.717,6.319-1.791,7.971c-2.219,1.475-4.068,3.445-5.455,5.785c-0.22,0.381-0.439,0.763-0.624,1.17h-0.011 c-0.717,1.424-1.271,2.962-1.63,4.59c-1.086,4.857-0.393,9.891,1.953,14.176c3.282,5.975,10.066,8.238,15.752,5.53 c0.509-0.242,1.017-0.521,1.503-0.852c4.241-2.822,5.617-8.912,3.051-13.578c-1.202-2.187-0.936-4.908,0.509-6.764 c0.347-0.47,0.774-0.89,1.283-1.221c2.496-1.653,5.732-0.775,7.246,1.971C352.468,153.295,349.498,166.542,340.275,172.67z "
                            ></path>{" "}
                          </g>{" "}
                          <g>
                            {" "}
                  ...
                  <g>
                    ...
                    >
                      ...
                      <stop
                        offset=".9951"
                        style={{ stopColor: "#F8D782" }}
                      ></stop>{" "}
                    </linearGradient>{" "}
                    <path
                      style={{ fill: "url(#SVGID_26_)" }}
                      d="M231.433,21.528c-0.444,11.627-1.037,25.105-1.777,40.064 c-2.296,47.84-7.85,84.72-15.108,113.083c-0.963,3.851-1.999,7.554-3.036,11.108c-3.258,1.63-6.517,3.111-9.701,4.517 c-1.63,0-2.518-0.074-2.518-0.074s-1.111,0.074-3.184,0.074c-3.184-1.333-6.369-2.814-9.553-4.443 c-1.037-3.555-2.074-7.257-3.036-11.183c-7.257-28.363-12.812-65.243-15.181-113.083c-0.37-8.517-0.74-16.515-1.111-23.92 c-0.222-5.48-0.444-10.738-0.667-15.626c7.998-8.813,18.958-14.367,31.104-14.811c0.518-0.074,1.111-0.074,1.629-0.074 C211.808,7.162,223.065,12.642,231.433,21.528z"
                    ></path>{" "}
                    <linearGradient
                      id="SVGID_27_"
                      gradientUnits="userSpaceOnUse"
              ...
              <g style={{ opacity: 0.5 }}>
                ...
                <path
                  style={{ fill: "#FFFFFF" }}
                  d="M122.458,399.473c-4.328,0-7.868,3.54-7.868,7.868v48.136c0,4.327,3.541,7.868,7.868,7.868h79.351 v-63.873H122.458z"
                ></path>{" "}
                <path
                  style={{ fill: "#FEFEF3" }}
                  d="M278.92,455.477v-48.136c0-4.328-3.541-7.868-7.868-7.868h-74.315v63.873h74.315 C275.379,463.346,278.92,459.805,278.92,455.477z"
                ></path>{" "}
              </g>{" "}
              <rect
                x="142.358"
